...
class BamlAsyncClient:
    ...
    async def DetermineWorkflowCompletionStatus(
        self,
      ...
      return cast(types.WorkflowCompletionStatus, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def DetermineWorkflowCompletionStatus(
        ...
        input: types.WorkflowAnalysisDetails,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.WorkflowCompletionStatus, types.WorkflowCompletionStatus]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.WorkflowCompletionStatus, types.WorkflowCompletionStatus](
        raw,
        lambda x: cast(partial_types.WorkflowCompletionStatus, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.WorkflowCompletionStatus, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
